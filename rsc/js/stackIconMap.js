// file: stackIconMap.js
// Populated using #file:stack map.md as inventory
...
export const iconSvgs = {
    ...
    Docker: `
        <svg width="100" height="100" viewBox="0 0 256 256" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
            <!-- Placeholder for Docker icon -->
            <rect width="256" height="256" rx="20" fill="#0db7ed"/>
            <text x="50%" y="50%" text-anchor="middle" fill="#fff" font-size="24px" dy=".3em">
                Docker
            </text>
        </svg>
    `,
